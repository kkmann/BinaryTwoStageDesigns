...
the ideas of [Simon1989]_ using the `Julia <https://julialang.org/>`_
...
Julia containers provided by `<https://juliabox.com/>`_ for free.

Make sure Gurobi/`Gurobi.jl <https://github.com/JuliaOpt/Gurobi.jl>`_/JuMP are
...
`<https://imbi-heidelberg.github.io/BinaryTwoStageDesigns>`_ and previous versions
